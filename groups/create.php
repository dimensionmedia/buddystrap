...
get_header( 'buddypress' ); ?>
	...
	<div id="content" class="span8">
		...
		<form action="<?php bp_group_creation_form_action(); ?>" method="post" id="create-group-form" class="standard-form" enctype="multipart/form-data">
			<h3><?php _e( 'Create a Group', 'buddypress' ); ?> &nbsp;<a class="btn btn-info btn-small" href="<?php echo trailingslashit( bp_get_root_domain() . '/' . bp_get_groups_root_slug() ); ?>"><?php _e( 'Groups Directory', 'buddypress' ); ?></a></h3>
			...
			<div class="item-body" id="group-create-body">
				...
				<?php if ( bp_is_group_creation_step( 'group-avatar' ) ) : ?>
					...
					<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
						...
						<div class="main-column">
							...
							<p>
								...
								<input type="submit" class="btn btn-success btn-small" name="upload" id="upload" value="<?php _e( 'Upload Image', 'buddypress' ); ?>" />
					...
					<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
						...
						<input type="submit" class="btn btn-success btn-small" name="avatar-crop-submit" id="avatar-crop-submit" value="<?php _e( 'Crop Image', 'buddypress' ); ?>" />
				...
				<?php if ( 'crop-image' != bp_get_avatar_admin_step() ) : ?>
					...
					<div class="submit" id="previous-next">
						...
						<?php if ( !bp_is_first_group_creation_step() ) : ?>
							...
							<input type="button" class="btn btn-small" value="<?php _e( 'Back to Previous Step', 'buddypress' ); ?>" id="group-creation-previous" name="previous" onclick="location.href='<?php bp_group_creation_previous_link(); ?>'" />
						...
						<?php if ( !bp_is_last_group_creation_step() && !bp_is_first_group_creation_step() ) : ?>
							...
							<input type="submit" class="btn btn-success btn-small" value="<?php _e( 'Next Step', 'buddypress' ); ?>" id="group-creation-next" name="save" />
						...
						<?php if ( bp_is_first_group_creation_step() ) : ?>
							...
							<input type="submit" class="btn btn-success btn-small" class="btn btn-success btn-small" value="<?php _e( 'Create Group and Continue', 'buddypress' ); ?>" id="group-creation-create" name="save" />
						...
						<?php if ( bp_is_last_group_creation_step() ) : ?>
							...
							<input type="submit" class="btn btn-success btn-small" value="<?php _e( 'Finish', 'buddypress' ); ?>" id="group-creation-finish" name="save" />
