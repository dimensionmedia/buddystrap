<form action="<?php bp_messages_form_action('compose'); ?>" method="post" id="send_message_form" class="standard-form" role="main">
	...
	<input type="text"  class="input-xlarge" name="subject" id="subject" value="<?php bp_messages_subject_value(); ?>" />

	<label for="content"><?php _e( 'Message', 'buddypress'); ?></label>
	<textarea name="content" class="input-xlarge" id="message_content" rows="15" cols="40"><?php bp_messages_content_value(); ?></textarea>
	...
	<div class="submit">
		<input type="submit" class="btn btn-success" value="<?php _e( "Send Message", 'buddypress' ); ?>" name="send" id="send" />
	</div>
