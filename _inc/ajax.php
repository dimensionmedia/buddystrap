...
function bp_dtheme_ajax_addremove_friend() {
	...
	if ( 'is_friend' == BP_Friends_Friendship::check_is_friend( bp_loggedin_user_id(), $_POST['fid'] ) ) {
		...
		if ( ! friends_remove_friend( bp_loggedin_user_id(), $_POST['fid'] ) )
			...
			echo '<a id="friend-' . $_POST['fid'] . '" class="btn btn-success add" rel="add" title="' . __( 'Add Friend', 'buddypress' ) . '" href="' . wp_nonce_url( bp_loggedin_user_domain() . bp_get_friends_slug() . '/add-friend/' . $_POST['fid'], 'friends_add_friend' ) . '"><i class="icon-plus"></i>&nbsp;&nbsp;' . __( 'Add Friend', 'buddypress' ) . '</a>';
		...
		if ( ! friends_add_friend( bp_loggedin_user_id(), $_POST['fid'] ) )
			...
			echo '<a id="friend-' . $_POST['fid'] . '" class="btn btn-danger remove" rel="remove" title="' . __( 'Cancel Friendship Request', 'buddypress' ) . '" href="' . wp_nonce_url( bp_loggedin_user_domain() . bp_get_friends_slug() . '/requests/cancel/' . (int) $_POST['fid'] . '/', 'friends_withdraw_friendship' ) . '" class="requested"><i class="icon-thumbs-down"></i>&nbsp;&nbsp;' . __( 'Cancel Friendship Request', 'buddypress' ) . '</a>';
